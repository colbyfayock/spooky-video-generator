...
The story should be a maximum of ${sectionCount} sentences.
...
The response should only include JSON and nothing else.
      ...
      {
        role: 'user',
        content: `Generate a spooky story that uses at most ${sectionCount} of the following images: ${JSON.stringify(images)}`
      }
    ],
    response_format: {
      type: 'json_object'
